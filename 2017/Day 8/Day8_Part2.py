...
def main():
    ...
    for line in raw_input:
        ...
        current_largest_value = findLargestValue(register_list)
        if (current_largest_value > largest_value):
            largest_value = current_largest_value
